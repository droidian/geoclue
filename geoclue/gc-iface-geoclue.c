...
static gboolean gc_iface_geoclue_set_options (GcIfaceGeoclue *gc,
                                              GHashTable     *options,
                                              GError        **error);
static void gc_iface_geoclue_ref (GcIfaceGeoclue *gc,
				      DBusGMethodInvocation *context);
static void gc_iface_geoclue_unref (GcIfaceGeoclue *gc,
					DBusGMethodInvocation *context);
...
static void 
gc_iface_geoclue_ref (GcIfaceGeoclue *gc,
                      DBusGMethodInvocation *context)
{
	GC_IFACE_GEOCLUE_GET_CLASS (gc)->ref (gc, context);
}
static void 
gc_iface_geoclue_unref (GcIfaceGeoclue *gc,
                        DBusGMethodInvocation *context)
{
	GC_IFACE_GEOCLUE_GET_CLASS (gc)->unref (gc, context);
}
